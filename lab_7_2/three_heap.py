...
def parent_index_3_heap(child_index):
    ...
    return parent_index if child_index != 1 else None


def child_indices_7_heap(parent):
    """child of 7 heap"""
    return list(range(7*parent-5, 7*parent+2))


def child_indices(parent, branch_factor):
    """child of indexes"""
    return list(range(branch_factor * parent - branch_factor + 2, branch_factor * parent + 2))


def parent_index_6_heap(child_index):
    """parent of 6 heap"""
    return (child_index+4) // 6 if child_index != 1 else None
...
if __name__ == '__main__':
    ...
    #     my_heap.insert(item)
    # print(my_heap)
    # print(child_indices_7_heap(3))
    # print(parent_index_3_heap(1))
    # print(child_indices(1,3))
    print(parent_index_6_heap(841))
