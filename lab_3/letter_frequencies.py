...
class UnsortedFreqList(FreqList):
    ...
    def add(self, new_item):
        ...
        current = self.head
        while current is not None and current.item != new_item:
            current = current.next_node
        if current is None:
...
class NicerUnsortedFreqList(FreqList):
    ...
    def add(self, new_item):
        ...
        if current is None:
            self.head = temp
        elif current.item == new_item:
            current.increment()
        else:
            while current.next_node is not None and current.next_node.item != new_item:
                current = current.next_node
